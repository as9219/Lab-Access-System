This project showcases the CRUD Operations and a GUI Interface using <code>PyQt5</code> in Python. The database used for this project was <code>firebase</code>. The GUI was made using a module PyQt5.
